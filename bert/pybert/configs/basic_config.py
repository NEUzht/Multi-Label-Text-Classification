...
config = {
    ...
    'test_path': BASE_DIR / 'dataset/test2.csv',
    ...
    'bert_vocab_path': BASE_DIR / 'pretrain/bert/bert-base-chinese',
    'bert_config_file': BASE_DIR / 'pretrain/bert/bert-base-chinese/config.json',
    'bert_model_dir': BASE_DIR / 'pretrain/bert/bert-base-chinese',
