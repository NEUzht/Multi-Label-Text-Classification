...
class Transformer(nn.Module):
    ...
    def forward(self,ids, mask, token_type_ids):
        raw_outputs = self.base_model(ids, attention_mask = mask, token_type_ids = token_type_ids, return_dict=True)
...
#     def __init__(self, base_model, num_classes, input_size):
#         super(Transformer, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         self.input_size = input_size
#         self.linear = nn.Linear(base_model.config.hidden_size, num_classes)
...
# class Gru_Model(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes, input_size):
#         super(Gru_Model, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         self.input_size = input_size
#         self.Gru = nn.GRU(input_size=self.input_size,
...
# # Try to use the softmax、relu、tanh and logistic
# class Lstm_Model(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes, input_size):
#         super(Lstm_Model, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         self.input_size = input_size
#         self.Lstm = nn.LSTM(input_size=self.input_size,
...
# class BiLstm_Model(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes, input_size):
#         super(BiLstm_Model, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         self.input_size = input_size
#         # Open the bidirectional
...
# class Rnn_Model(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes, input_size):
#         super(Rnn_Model, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         self.input_size = input_size
#         self.Rnn = nn.RNN(input_size=self.input_size,
...
# class TextCNN_Model(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes):
#         super(TextCNN_Model, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         for param in base_model.parameters():
#             param.requires_grad = (True)
...
# class Transformer_CNN_RNN(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes):
#         super(Transformer_CNN_RNN, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         for param in base_model.parameters():
#             param.requires_grad = (True)
...
# class Transformer_Attention(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes):
#         super(Transformer_Attention, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         for param in base_model.parameters():
#             param.requires_grad = (True)
...
# class Transformer_CNN_RNN_Attention(BertPreTrainedModel):
#     def __init__(self, base_model, num_classes):
#         super(Transformer_CNN_RNN_Attention, self).__init__(base_model.config)
#         self.base_model = base_model
#         self.num_classes = num_classes
#         for param in base_model.parameters():
#             param.requires_grad = (True)
